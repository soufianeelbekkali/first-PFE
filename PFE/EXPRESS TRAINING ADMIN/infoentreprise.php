      ...
      <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="voiroffre.php" class="nav-item nav-link "><i class=" far fa-file-alt me-2 "></i> voir les offres </a>
                    <a href="infoentreprise.php" class="nav-item nav-link active "><i class="fa fa-chart-bar me-2 "></i> Info  Entreprise</a>
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
                        ...
                        <div class="container-fluid pt-4 px-4">
                            <div class="bg-light text-center rounded p-4">
                                ...
                                <h6 class="mb-4 " style="color:#e584cb; "> LES INFORMATION SUR LES ENTREPRISE</h6><br>
         ...
         $db="gestionstagaire";
            ...
            {
                $id=$_POST['id'];
                $sql =(" DELETE FROM 'post_entreprise' WHERE 'id' = '$id' ");
                $result= $con->query($sql);
            }

                $reqAFF="select * from post_entreprise";
                 ...
                 <td><?= $ligne["entreprise"] ?></td>
                  ...
                  <td><?= $ligne["date"] ?></td>
                  <td><a href="infoentreprise.php?deleteOffr=<?php echo $ligne["entreprise"] ; ?>" style="color:red;">Supprimer</a></td>
                  </tr></tbody>
               <?php }
                echo'</table>';
              if(isset($_GET["deleteOffr"])){
               $reqdelete="delete from post_entreprise where entreprise='".$_GET["deleteOffr"]."'";
               ...
               echo' <script>
               function myFunction() {
                 location.replace("infoentreprise.php")
               }
               </script>';
              }
                   ?>                   
