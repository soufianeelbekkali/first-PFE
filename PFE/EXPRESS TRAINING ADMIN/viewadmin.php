    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="voiroffre.php" class="nav-item nav-link "><i class=" far fa-file-alt me-2 "></i> voir les offres </a>
                    ...
                    <a href="viewadmin.php" class="nav-item nav-link  active"><i class=" far fa-file-alt me-2 "></i>Voir Les Admins </a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-4 " style="color:#e584cb; "> LES INFORMATION DES ADMIN  </h6>
         ...
         $db="gestionstagaire";
            $con=new mysqli($localhost,$username,$pass,$db);
                ...
                $reqAFF="select * from admiiin";
                 ...
                 while($ligne=$resultat->fetch_assoc()){?>
                    ...
                    <tbody><tr>
                     ...
                     <td><a href="viewadmin.php?deleteOffr=<?php echo $ligne["name"] ; ?>" style="color:red;">Supprimer</a></td>
                     
                     </tr></tbody>
                  <?php }
                   echo'</table>';
                 if(isset($_GET["deleteOffr"])){
                  $reqdelete="delete from admiiin where name='".$_GET["deleteOffr"]."'";
                ...
                echo' <script>
                function myFunction() {
                  location.replace("viewadmin.php")
                }
                </script>';
