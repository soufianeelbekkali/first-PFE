    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="voiroffre.php" class="nav-item nav-link active "><i class=" far fa-file-alt me-2 "></i> voir les offres </a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-4 " style="color:#e584cb; ">DES INFOS SUR LES OFFRES </h6>
         ...
         $db="gestionstagaire";
            $con=new mysqli($localhost,$username,$pass,$db);
                ...
                $reqAFF="select * from postadmiiin";
                 $resultat=$con->query($reqAFF);
                 echo '       <table id="example" class="table text-start align-middle table-bordered table-hover mb-0" > <thead>
                 <tr class="text-dark">
                     <th scope="col">NOM</th>
                 ...
                 while($ligne=$resultat->fetch_assoc()){?>
                  ...
                  <tbody><tr>
                   <td><?= $ligne["name"] ?></td>
                   <td><?= $ligne["message"] ?></td>
                   <td><a href="voiroffre.php?deleteOffr=<?php echo $ligne["name"] ; ?>" style="color:red;">Supprimer</a></td>
                   </tr></tbody>
                <?php }
                 echo'</table>';
               if(isset($_GET["deleteOffr"])){
                $reqdelete="delete from postadmiiin where name='".$_GET["deleteOffr"]."'";
                if($con->query($reqdelete)){
                    echo 
                    '<div class="alert alert-danger d-flex align-items-center" role="alert">
                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>le post a ete supprime
                    <button type="button"  onclick="myFunction()" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    <div>'; 
                }
                echo' <script>
                function myFunction() {
                  location.replace("voiroffre.php")
                }
                </script>';
               }
                    ?>
