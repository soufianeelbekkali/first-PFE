...
<section class="book" id="book" style="background-color: #e584cb;">
    <br><br><br>
   <br>
    <h1 class="heading"> <span>   vous êtes un stagaire </span> </h1>
	...
	if (isset($_POST['valider'])) {
        ...
        $requete="INSERT INTO stagaire  VALUES(' ". $_POST['nom'] . "', '" . $_POST['email'] . "', '".$_POST['password']."' )";
        $resultat = $con -> query($requete);
      //petit test 
        if ($resultat){
            echo "<script> alert('le compte a ete  cree !!!')</script>";
            echo'  <h2><i style="color:red;" class="fas fa-chevron-right"></i><a style=" color:red;" href="POSTSTAGAIRE.php"> Pour faire un post , qulique ici !</a></h2> ';

        }else{
            echo "  <script> alert('eroooores !!!')</script> ";
        }
    }
        ?>
            <pre>
            <input type="text" name="nom" class="box" placeholder="votre name"required><br>
